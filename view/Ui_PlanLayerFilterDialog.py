...
class Ui_PlanLayerFilterDialog(object):
    def setupUi(self, PlanLayerFilterDialog):
        ...
        self.ok_button = QtGui.QPushButton(PlanLayerFilterDialog)
        self.ok_button.setGeometry(QtCore.QRect(366, 630, 75, 23))
    ...
    def retranslateUi(self, PlanLayerFilterDialog):
        ...
        self.ok_button.setText(_translate("PlanLayerFilterDialog", "Ok", None))
